...
########## Kubernetes Demo Code: ####################

pe "kubectl create deployment hello-minikube1 --image=k8s.gcr.io/echoserver:1.4"
pe "kubectl expose deployment hello-minikube1 --type=LoadBalancer --port=8080"
pe "kubectl get deployment hello-minikube1 -o yaml"
